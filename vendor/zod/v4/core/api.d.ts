...
export declare function _intersection<T extends schemas.$ZodObject, U extends schemas.$ZodObject>(
...
export declare function _tuple<T extends readonly [schemas.$ZodType, ...schemas.$ZodType[]]>(
...
export declare function _map<Key extends schemas.$ZodObject, Value extends schemas.$ZodObject>(
...
export declare function _templateLiteral<const Parts extends schemas.$ZodTemplateLiteralPart[]>(
